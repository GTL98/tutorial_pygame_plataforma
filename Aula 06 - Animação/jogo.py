...
from scripts.entidades import Jogador
from scripts.utils import Animacao, carregar_imagem, carregar_imagens
...
class Jogo:
    ...
    def __init__(self):
        ...
        # --- Criar a tela --- #
        self.TELA = pygame.display.set_mode((960, 720))
        ...
        self.assets = {
            ...
            'player/idle': Animacao(carregar_imagens('entities/player/idle'), imagem_duracao=6),
            'player/run': Animacao(carregar_imagens('entities/player/run'), imagem_duracao=4),
            'player/jump': Animacao(carregar_imagens('entities/player/jump')),
            'player/slide': Animacao(carregar_imagens('entities/player/slide')),
            'player/wall_slide': Animacao(carregar_imagens('entities/player/wall_slide'))
        }
